...
print(ano_formatura <= ano_nascimento)  # menor ou igual
print(ano_formatura == ano_nascimento)  # igual

# Crie expressões comparativas mais complexas utilizando operadores lógicos and, or e not. Imprima na tela as respostas

print(ano_formatura > ano_nascimento and idade_formatura > 18)
print(ano_formatura < ano_nascimento or idade_formatura > 18)
